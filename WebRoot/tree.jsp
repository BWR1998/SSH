...
var treeMenu = [
	{ level:1, name:"库存管理"},
	{ level:2, name:"服饰列表", ico:"images/icon_default.gif",link:"clothes/Clothes_query.action"},
	{ level:1, name:"出库管理"},
	{ level:2, name:"出库详单列表", ico:"images/icon_default.gif",link:"outbounddetails/Outbounddetails_query.action"},
	{ level:1, name:"入库管理"},
	{ level:2, name:"入库详单列表", ico:"images/icon_default.gif",link:"warehousedetails/Warehousedetails_query.action"},
