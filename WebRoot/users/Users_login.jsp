...
<div id="wrapper">
			...
			<div id="mainPanel">
				...
				<div id="right">
					...
					<div id="user-name">
						...
						<span><input type="text" name="users_id" class="form-input"></span>
					</div>
					<div id="user-password">
						<span class="item">密&nbsp;&nbsp;&nbsp;码:</span>
						<span class="input"><input type="password" name="users_tel" class="form-input"></span>
					</div>
					<br><br>
						<div style="color:red"><s:property value="#request.message" /></div>
					<div id="button-group">
	...
	<div id="footer">
		<div id="text">Copyright © 2015 All Rights Reserved Powered</div>
	</div>
</div>
</body>
</html>